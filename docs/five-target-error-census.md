...
| K3 | 各目标错误总数 | kotlin f32 146 / f64 49；rust f32 3058 / f64 3055；ts 330；dart 303（生成侧 260、测试侧 43）；swift f32 297 / f64 266（WMO 全模块测量）。全部为 census17 实测值（boring `f3099727` × tiqian `3f609c0f`） | 全部 0 | 各节逐类表求和（完整性数字，非派发单位） |
