...
class LayoutQueriesResidualCoverageTest {
    ...
    public static function copyProjectionAppendsFullySelectedAnnotationsOnly():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("abcd", [], [], [], [], [], debug, LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function positionedClustersByLineRejectsForeignLines():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), "ab", 20.0)], [owned], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function glyphInkBoundsSkipsUnmatchedGlyphsAndReturnsNullWithoutInk():Void {
        ...
        final noInk:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", clusters, [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function emptyLineResultsShortCircuitEveryQuery():Void {
        ...
        TracedAssertions.assertEqualsRendered("[]", LayoutQueriesResidualCoverageTestHelpers.renderSegments(LayoutQueries.positionedRichTextSegments(content, [new RichTextSpan(new TextRange(0, 1), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0))])));
    ...
    public static function boundingBoxFallsBackToTheCursorRectAtClusterGaps():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abc",
            [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0)],
        ...
        TracedAssertions.assertEqualsRendered("[]", LayoutQueriesResidualCoverageTestHelpers.renderRects(LayoutQueries.getBoundingBoxes(content, new TextRange(3, 5))));
    }
    ...
    public static function richTextSegmentsSplitOnLineBreaksAndClusterGaps():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abcd",
            [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(3, 4), "d", 10.0)],
            [
        ...
        final span:RichTextSpan = new RichTextSpan(new TextRange(0, 4), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0));
        ...
        TracedAssertions.assertTrue(LayoutQueries.positionedRichTextSegments(content, [new RichTextSpan(new TextRange(5, 8), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0))]).length == 0);
    }
    ...
    public static function richTextSegmentsSkipZeroLengthClustersBetweenSlices():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab",
            [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 1), "", 0.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 2, 0.0, 20.0, 15.0, 0.0, 20.0)],
            [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
        final segments:Array<RichTextLineSegment> = LayoutQueries.positionedRichTextSegments(content, [new RichTextSpan(new TextRange(0, 2), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0))]);
    ...
    public static function trimmedDecorationSegmentsKeepOnlyDecorationRoles():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", [], [], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        final decoration:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 2), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 2), 0.0, 0.0, 20.0, 20.0, 15.0);
    ...
    public static function backgroundSegmentsPassThroughUnmatchableSegments():Void {
        ...
        final orphan:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 5, new TextRange(0, 1), 0.0, 0.0, 20.0, 20.0, 15.0);
        ...
        final underline:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 1), 0.0, 0.0, 20.0, 20.0, 15.0);
    ...
    public static function backgroundSegmentsTrimGlueApplyPaddingAndUseGlyphAdvances():Void {
        ...
        final clusters:Array<Cluster> = [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "，", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "字", 10.0)];
        ...
        final full:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(content, [LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 2), 0.0, 0.0, 20.0, 20.0, 15.0)]);
    ...
    public static function adjacentSameStyleSegmentsShareClearance():Void {
        ...
        final other:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(1, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 3.0, 3.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance),  0.0), 0, new TextRange(1, 2), 10.0, 0.0, 20.0, 20.0, 15.0);
    ...
    public static function decorationLineYRequiresValidStrokeAndDecorationRoles():Void {
        ...
        final withSpanStyle:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 10.0)], [],
            [new TextSpan(new TextRange(0, 1), LayoutQueriesResidualCoverageTestHelpers.style(10.0))], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
        ...
        final lineThrough:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.LineThrough, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 1), 0.0, 0.0, 20.0, 20.0, 15.0);
    ...
    public static function cursorRectCoversEmptyLinesEmptyClustersAndMultiUnitClusters():Void {
        ...
        final withEmptyLine:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("a", [], [emptyClusterLine], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        ...
        final linear:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), "ab", 20.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        TracedAssertions.assertEqualsFloat(10.0, LayoutQueries.getCursorRect(linear, 1).left);
        final stops:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), "ab", 20.0)],
            ...
            ], 20.0, [])], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function offsetForPositionCoversVerticalDistancesAndNaNPoints():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 10.0)],
            [
        ...
        final withStops:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), "ab", 20.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 20.0)],
            [new GlyphRun(new TextRange(0, 2), "test", [
                new Glyph(1, new TextRange(0, 2), 10.0, 0.0, 0.0, null, null, null, null),
    ...
    public static function selectionSnapPrefersTheCloserInlineObjectBoundary():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("abb", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 3), "abb", 30.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 0, 0.0, 20.0, 15.0, 0.0, 30.0)], [], [], [object], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function selectionWordBoundaryForPositionRejectsDegenerateContent():Void {
        ...
        final emptyText:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("", [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 0), 0, -1, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        ...
        final emptyLine:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "a", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 1), 0, 0, 0.0, 20.0, 15.0, 0.0, 10.0), LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(1, 1), 1, -1, 20.0, 40.0, 35.0, 0.0, 0.0)],
            [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
        ...
        final leadingEmpty:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "a", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 0), "", 0.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0)],
    ...
    public static function zeroWidthClustersReturnTheirStartInHitTests():Void {
        ...
        final emptyRange:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 0), "", 5.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 0), 0, 0, 0.0, 20.0, 15.0, 0.0, 5.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        TracedAssertions.assertEqualsInt(0, LayoutQueries.getOffsetForPosition(emptyRange, 2.0, 5.0));
        final zeroAdvance:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 0.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 1), 0, 0, 0.0, 20.0, 15.0, 0.0, 10.0), LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(1, 2), 1, 1, 20.0, 40.0, 35.0, 0.0, 0.0)],
            [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function coerceSelectionOffsetHonoursInlineObjectBoundaries():Void {
        ...
        final object:InlineObjectSpan = new InlineObjectSpan(new TextRange(1, 3), 8.0, 4.0, 4.0, InlineObjectBoundaryAdjustment.fixed(), InlineObjectBoundaryAdjustment.fixed());
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("abb", [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 0, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [object], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function selectionWordBoundaryExpandsWordsAndHonoursInlineObjects():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("hello", [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 5), 0, 0, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        ...
        final emoji:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(emojiText, [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        TracedAssertions.assertEqualsRendered(new TextRange(0, 2).toString(), LayoutQueries.getSelectionWordBoundary(emoji, 1).toString());
        final object:InlineObjectSpan = new InlineObjectSpan(new TextRange(1, 3), 8.0, 4.0, 4.0, InlineObjectBoundaryAdjustment.fixed(), InlineObjectBoundaryAdjustment.fixed());
        final withObject:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("abb", [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 0, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [object], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        ...
        final mandatory:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("a\nb", [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 0, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        ...
        final connectors:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("a_b", [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 0, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        ...
        final empty:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("", [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 0), 0, -1, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function selectionWordKindCoversEveryHanBlock():Void {
        ...
        while (index < values.length) {
            ...
            final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(text, [], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, text.length), 0, 0, 0.0, 20.0, 15.0, 0.0, 0.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function nearestLineFallsBackToTheOnlyLineAtItsEndOffset():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("abc", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), "ab", 20.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function rubyGeometryRedistributesSelectionBoxesAndDropsSourceStops():Void {
        ...
        final clusters:Array<Cluster> = [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), "ab", 20.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0)];
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("abc", clusters, [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 1, 0.0, 20.0, 15.0, 0.0, 30.0)], runs, [], [], new LayoutDebugInfo(null, [], [], [], [matching, stray], []), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function boundingBoxesSliceZeroWidthAndEmptyClusters():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 0.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 10.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function positionedClustersAndSegmentsReturnEmptyWithoutLines():Void {
        ...
        TracedAssertions.assertTrue(LayoutQueries.positionedRichTextSegments(noLines, [new RichTextSpan(new TextRange(0, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0))]).length == 0);
    ...
    public static function sameSpanSlicesAcrossASourceBoundaryMergeIntoOneSegment():Void {
        ...
        final segments:Array<RichTextLineSegment> = LayoutQueries.positionedRichTextSegments(content, [new RichTextSpan(new TextRange(0, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0))]);
        TracedAssertions.assertEqualsInt(1, segments.length);
        TracedAssertions.assertEqualsRendered(new TextRange(0, 2).toString(), segments[0].range.toString());
        TracedAssertions.assertEqualsFloat(0.0, segments[0].left);
        TracedAssertions.assertEqualsFloat(20.0, segments[0].right);
    ...
    public static function glyphInkBoundsSkipsUnusableGlyphsAndReportsNull():Void {
        ...
        final noBounds:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", clusters, lines, [new GlyphRun(new TextRange(0, 2), "test", [new Glyph(1, new TextRange(0, 1), 10.0, 0.0, 0.0, null, null, null, null)], 20.0, [])], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        ...
        final nanPlaced:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", clusters, lines, [new GlyphRun(new TextRange(1, 2), "test", [new Glyph(9, new TextRange(1, 2), 9.0, LayoutQueriesResidualCoverageTestHelpers.nan(), 0.0, null, new Rect(1.0, 2.0, 8.0, 4.0), null, null)], 10.0, [])], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        ...
        final usable:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab", clusters, lines,
            [new GlyphRun(new TextRange(0, 2), "test", [
    ...
    public static function backgroundTrailingEdgeUsesGlyphAdvancesWhenAvailable():Void {
        ...
        final shortSegments:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(shortGlyph, [LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 2), 0.0, 0.0, 20.0, 20.0, 15.0)]);
        ...
        final emptySegments:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(emptyGlyphRun, [LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 2), 0.0, 0.0, 20.0, 20.0, 15.0)]);
    ...
    public static function clearanceNeedsSameRoleAndUsesTheSmallerSide():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 10.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        final background:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 4.0), 0, new TextRange(0, 1), 0.0, 0.0, 10.0, 20.0, 15.0);
        final inlineCode:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(1, 2), RichTextRole.InlineCode, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 4.0), 0, new TextRange(1, 2), 10.0, 0.0, 20.0, 20.0, 15.0);
        ...
        final weak:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 2.0), 0, new TextRange(0, 1), 0.0, 0.0, 10.0, 20.0, 15.0);
        final strong:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(1, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 6.0), 0, new TextRange(1, 2), 10.0, 0.0, 20.0, 20.0, 15.0);
    ...
    public static function decorationStyleResolvesInsideSpansAndAtTheirEdges():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abc",
            [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0)],
        ...
        final between:Float = LayoutQueries.richTextDecorationLineY(content, LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(1, 2), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(1, 2), 10.0, 0.0, 20.0, 20.0, 15.0), 1.0);
        final inside:Float = LayoutQueries.richTextDecorationLineY(content, LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(2, 3), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(2, 3), 20.0, 0.0, 30.0, 20.0, 15.0), 1.0);
    ...
    public static function glueTrimSkipsInteriorSegmentEdges():Void {
        ...
        final interiorStart:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(content, [LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(1, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(1, 2), 10.0, 0.0, 20.0, 20.0, 15.0)]);
        TracedAssertions.assertEqualsFloat(10.0, interiorStart[0].left);
        final interiorEnd:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(content, [LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 1), 0.0, 0.0, 10.0, 20.0, 15.0)]);
    ...
    public static function backgroundSegmentOutsideEverySpanUsesTheParagraphStyle():Void {
        ...
        final atEnd:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(content, [LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(2, 3), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(2, 3), 20.0, 0.0, 30.0, 20.0, 15.0)]);
    ...
    public static function cursorRectFindsLaterClustersAndRejectsGappedRanges():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            ...
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 2, 0.0, 20.0, 15.0, 0.0, 30.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
        TracedAssertions.assertEqualsFloat(20.0, LayoutQueries.getCursorRect(content, 2).left);
        final gapped:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abcde", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(4, 5), "e", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 5), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function emptyMidClusterHoldsTheCaretAndSlicesKeepDegenerateRects():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abc", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 2), "", 0.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 2, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
        TracedAssertions.assertEqualsFloat(10.0, LayoutQueries.getCursorRect(content, 2).left);
        final withEmpty:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 1), "", 0.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 2, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
        ...
        final zeroAdvance:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abc", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 0.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 2, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function selectionWordBoundarySkipsInlineObjectsItDoesNotContain():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("abcdefg", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 7), "abcdefg", 70.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 7), 0, 0, 0.0, 20.0, 15.0, 0.0, 70.0)], [], [], objects, LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
    ...
    public static function selectionWordBoundaryForPositionCoversDistancesAndFallbacks():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "甲乙", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "甲", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "乙", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function lineForOffsetInsideARangeTakesTheZeroDistanceArm():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abcde", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(4, 5), "e", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 10.0), LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(4, 5), 1, 1, 20.0, 40.0, 35.0, 0.0, 10.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function compatibilityIdeographsFormIndividualWordUnits():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            text, [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), TestHelpers.surrogateText([0xD840, 0xDC00]), 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "\uF900", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function rubySpreadShiftsSelectionBoxesAndZeroWidthRubiesAreIgnored():Void {
        ...
        final clusters:Array<Cluster> = [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), "ab", 20.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0)];
        final geometries:Array<ClusterGeometryDecisionInfo> = [LayoutQueriesResidualCoverageTestHelpers.geometry(new TextRange(0, 2), "ab", 0.0, 0.0, 0.0, 0.0), LayoutQueriesResidualCoverageTestHelpers.geometry(new TextRange(2, 3), "c", 0.0, 0.0, 0.0, 0.0)];
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("abc", clusters, [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 1, 0.0, 20.0, 15.0, 0.0, 30.0)], [], [], [], new LayoutDebugInfo(null, [], geometries, [], rubies, []), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        final positioned:Array<PositionedCluster> = LayoutQueries.positionedClusters(content);
        TracedAssertions.assertEqualsFloat(0.0, positioned[0].left);
        TracedAssertions.assertEqualsFloat(15.75, positioned[0].right);
        TracedAssertions.assertEqualsFloat(15.75, positioned[1].left);
        TracedAssertions.assertEqualsFloat(30.0, positioned[1].right);
        final glyphResult:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abc", clusters, [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 3), 0, 1, 0.0, 20.0, 15.0, 0.0, 30.0)],
    ...
    public static function noArgPositionedClustersWalksEveryLine():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abcd",
            [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(3, 4), "d", 10.0)],
            [
                LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0),
    ...
    public static function clearanceTakesTheSmallerSideWhicheverSegmentOwnsIt():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 10.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        final weakFirst:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 6.0), 0, new TextRange(0, 1), 0.0, 0.0, 10.0, 20.0, 15.0);
        final strongSecond:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(1, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 2.0), 0, new TextRange(1, 2), 10.0, 0.0, 20.0, 20.0, 15.0);
        final cleared:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(content, [weakFirst, strongSecond]);
        TracedAssertions.assertEqualsFloat(9.0, cleared[0].right);
        TracedAssertions.assertEqualsFloat(11.0, cleared[1].left);
        final styledA:RichTextLineSegment = LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(1, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 4.0), 0, new TextRange(1, 2), 10.0, 0.0, 20.0, 20.0, 15.0);
        final scanPast:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(content, [
            LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(1, 2), RichTextRole.InlineCode, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 4.0), 0, new TextRange(1, 2), 10.0, 0.0, 20.0, 20.0, 15.0),
            LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 4.0), 0, new TextRange(0, 1), 0.0, 0.0, 10.0, 20.0, 15.0),
            styledA
        ]);
    ...
    public static function decorationLineYWithoutSpansUsesTheParagraphStyle():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), "ab", 20.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        final value:Float = LayoutQueries.richTextDecorationLineY(content, LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 2), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 2), 0.0, 0.0, 20.0, 20.0, 15.0), 1.0);
    ...
    public static function wordBoundaryForPositionHandlesANonFiniteY():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result("甲乙", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "甲", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "乙", 10.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        TracedAssertions.assertEqualsRendered(new TextRange(0, 1).toString(), LayoutQueries.getSelectionWordBoundaryForPosition(content, 5.0, LayoutQueriesResidualCoverageTestHelpers.nan()).toString());
    }
    ...
    public static function supplementaryIdeographBeyondTheHanRangesIsItsOwnUnit():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(text, [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 2), text, 10.0)], [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 10.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0));
        TracedAssertions.assertEqualsRendered(new TextRange(0, 2).toString(), LayoutQueries.getSelectionWordBoundary(content, 0).toString());
    }
    ...
    public static function rubiesOnOtherLinesDoNotAffectThisLineGeometry():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "ab", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "b", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0)], [], [], [],
            new LayoutDebugInfo(null, [], [], [], [new RubyDecisionInfo(new TextRange(0, 2), "zhù", 1, 10.0, 4.0, 6.0, 0.0, 0.0, 0.0, 30.0, [], 400, "zh-Hans", [])], []), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
        final positioned:Array<PositionedCluster> = LayoutQueries.positionedClusters(content);
        TracedAssertions.assertEqualsFloat(0.0, positioned[0].left);
    ...
    public static function selectionWordBoundaryForPositionPrefersTheCloserLaterLine():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "甲乙丙丁",
            [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "甲", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(1, 2), "乙", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "丙", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(3, 4), "丁", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0), LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(2, 4), 2, 3, 40.0, 60.0, 55.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function nearestLineSearchUpdatesToAStrictlyCloserLaterLine():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abcde", [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(0, 1), "a", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(5, 6), "e", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(0, 2), 0, 0, 0.0, 20.0, 15.0, 0.0, 10.0), LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(5, 7), 1, 1, 20.0, 40.0, 35.0, 10.0, 10.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function nearestLineSearchCoversBothLambdaCopiesOfEachArm():Void {
        ...
        final content:LayoutResult = LayoutQueriesResidualCoverageTestHelpers.result(
            "abcdefghij",
            [LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(2, 3), "c", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(3, 4), "d", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(6, 7), "g", 10.0), LayoutQueriesResidualCoverageTestHelpers.cluster(new TextRange(7, 8), "h", 10.0)],
            [LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(2, 4), 0, 1, 0.0, 20.0, 15.0, 0.0, 20.0), LayoutQueriesResidualCoverageTestHelpers.line(new TextRange(6, 8), 2, 3, 20.0, 40.0, 35.0, 0.0, 20.0)], [], [], [], LayoutQueriesResidualCoverageTestHelpers.emptyDebug(), LayoutQueriesResidualCoverageTestHelpers.style(10.0)
        );
    ...
    public static function decorationLineYPicksTheLastMatchingSpan():Void {
        ...
        final value:Float = LayoutQueries.richTextDecorationLineY(content, LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(2, 3), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(2, 3), 20.0, 0.0, 30.0, 20.0, 15.0), 1.0);
    ...
    public static function decorationLineYKeepsTheEarlierSpanWhenALaterOneMisses():Void {
        ...
        final value:Float = LayoutQueries.richTextDecorationLineY(content, LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 1), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 1), 0.0, 0.0, 10.0, 20.0, 15.0), 1.0);
        TracedAssertions.assertEqualsFloat(15.0 + 20.0 * 0.18, value);
    }
...
class LayoutQueriesResidualCoverageTestHelpers {
    ...
    public static function plainSegment(range:TextRange):RichTextLineSegment {
        return LayoutQueriesResidualCoverageTestHelpers.segment(range, RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, range, 0.0, 0.0, 20.0, 20.0, 15.0);
    }
    ...
    public static function geometry(range:TextRange, sourceText:String, leading:Float, leadingConsumed:Float, trailing:Float, trailingConsumed:Float):ClusterGeometryDecisionInfo {
    ...
    public static function metricBounds(decisionRange:TextRange):Array<Float> {
        ...
        final box:Array<RichTextLineSegment> = LayoutQueries.richTextBackgroundSegments(
            content,
            [LayoutQueriesResidualCoverageTestHelpers.segment(new TextRange(0, 2), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0), 0, new TextRange(0, 2), 0.0, 0.0, 20.0, 20.0, 15.0)]
        );
