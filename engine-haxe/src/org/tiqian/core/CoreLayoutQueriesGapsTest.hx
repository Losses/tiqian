...
class CoreLayoutQueriesGapsTest {
    ...
    public static function getLineForOffsetUsesNearestLineWhenGapBetweenLines():Void {
        ...
        final result:LayoutResult = CoreLayoutQueriesGapsTestHelpers.resultWith(
            "abcde",
            100.0,
            null,
            new Size(10.0, 40.0),
    ...
    public static function richTextBackgroundUsesHorizontalPadding():Void {
        ...
        final result:LayoutResult = CoreLayoutQueriesGapsTestHelpers.resultWith(
            "AB",
            100.0,
            CoreLayoutQueriesGapsTestHelpers.style(10.0),
            new Size(20.0, 20.0),
            [
    ...
    public static function richTextBackgroundUniformParagraphStyleUsesParagraphStyle():Void {
        ...
        final result:LayoutResult = CoreLayoutQueriesGapsTestHelpers.resultWith(
            "AB",
            100.0,
            CoreLayoutQueriesGapsTestHelpers.style(12.0),
            new Size(20.0, 20.0),
            [
                CoreLayoutQueriesGapsTestHelpers.cluster(new TextRange(0, 1), "A", "latin", 10.0),
                CoreLayoutQueriesGapsTestHelpers.cluster(new TextRange(1, 2), "B", "latin", 10.0)
    ...
    public static function positionedClustersProducesSourceStopsForLatinRun():Void {
        ...
        final result:LayoutResult = CoreLayoutQueriesGapsTestHelpers.resultWith(
            ...
            CoreLayoutQueriesGapsTestHelpers.style(10.0),
            new Size(20.0, 20.0),
            [CoreLayoutQueriesGapsTestHelpers.cluster(glyphRange, text, "latin", 20.0)],
...
class CoreLayoutQueriesGapsTestHelpers {
    ...
    public static function input(text:String, maxWidth:Float, textStyle:Null<TextStyle>):LayoutInput {
        ...
        return new LayoutInput(CoreLayoutQueriesGapsTestHelpers.content(text), style, new ParagraphStyle(LastLineAlignment.Start, WritingMode.HorizontalTb, null, null, Ic.Zero, new MeasureAdaptiveFirstLineIndent(14.0, 1.0, 2.0), new LineLengthGrid(true, null), RubyLineHeightMode.PerLine, ParagraphStyle.DEFAULT_INLINE_OBJECT_MINIMUM_CLEARANCE_EM, ParagraphStyle.DEFAULT_EMPHASIS_DOT_GAP_EM), CoreLayoutQueriesGapsTestHelpers.constraints(maxWidth), BuiltInLayoutProfiles.ClreqHorizontal, [], [], [], []);
    }
    ...
    public static function line(range:TextRange, clusterStart:Int, clusterEnd:Int, baseline:Float, top:Float, bottom:Float, width:Float, indent:Null<Float>):LineBox {
        return new LineBox(
            range,
    ...
    public static function resultWith(
        text:String,
        maxWidth:Float,
        ...
        return new LayoutResult(CoreLayoutQueriesGapsTestHelpers.input(text, maxWidth, textStyle), size, clusters, glyphRuns, lines, debug == null ? CoreLayoutQueriesGapsTestHelpers.emptyDebug() : debug);
    }

    public static function sampleResult():LayoutResult {
        final text:String = "甲——乙";
        final dashRange:TextRange = new TextRange(1, 3);
        return CoreLayoutQueriesGapsTestHelpers.resultWith(
            text,
            40.0,
            CoreLayoutQueriesGapsTestHelpers.style(10.0),
            new Size(34.0, 40.0),
