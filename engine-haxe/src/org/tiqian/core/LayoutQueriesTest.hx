...
class LayoutQueriesTest {
    ...
    public static function richTextDecorationTrimsOnlyOuterPunctuationGlue():Void {
        ...
        final underline:RichTextSpan = new RichTextSpan(new TextRange(0, 4), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0));
    ...
    public static function richTextDecorationKeepsPunctuationGlueInsideItsRange():Void {
        ...
        final result:LayoutResult = LayoutQueriesTestHelpers.punctuationGlueResult();
        final underline:RichTextSpan = new RichTextSpan(new TextRange(1, 4), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0));
        final occupied:Array<RichTextLineSegment> = LayoutQueries.positionedRichTextSegments(result, [underline]);
        final decorations:Array<RichTextLineSegment> = LayoutQueries.trimmedRichTextDecorationSegments(result, occupied);
    ...
    public static function richTextDecorationDoesNotTrimAlreadyConsumedOpeningGlueTwice():Void {
        ...
        final underline:RichTextSpan = new RichTextSpan(new TextRange(0, 1), RichTextRole.Underline, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0));
        final occupied:Array<RichTextLineSegment> = LayoutQueries.positionedRichTextSegments(result, [underline]);
        final decorations:Array<RichTextLineSegment> = LayoutQueries.trimmedRichTextDecorationSegments(result, occupied);
    ...
    public static function lineThroughBisectsTheIdeographicMetricBox():Void {
        ...
        final lineThrough:RichTextSpan = new RichTextSpan(new TextRange(0, 3), RichTextRole.LineThrough, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0));
    ...
    public static function richTextBackgroundKeepsInternalGapsButTrimsItsOuterLayoutSpace():Void {
        ...
        final full:RichTextSpan = new RichTextSpan(new TextRange(0, 3), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0));
        final finalCharacter:RichTextSpan = new RichTextSpan(new TextRange(2, 3), RichTextRole.Background, new RichTextPaint(null, Solid.instance, new RichTextBackgroundPaint(0.0, 0.0, 0.0, 0.0, RichTextBackgroundMetricPolicy.MarkedFaces, Fill.instance), 0.0));
