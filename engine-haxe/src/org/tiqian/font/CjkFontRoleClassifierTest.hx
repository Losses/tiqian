...
class CjkFontRoleClassifierTest {
    static function c(t:String, s:Int, e:Int):FontRole
    ...
    @:test public static function classifiesAsciiBracketsAsLatin():Void {
        ...
        while (xi < xs.length) {
            var x = xs[xi];
            TracedAssertions.assertEqualsRendered("LatinText", Std.string(c(x, x == "中(文" ? 1 : 0, x == "中(文" ? 2 : 1)));
            xi++;
        }
    }
    ...
    @:test public static function classifiesAsciiHyphenSlashTildeAsLatinRegardlessOfContext():Void {
        ...
        while (xi < xs.length) {
            ...
            TracedAssertions.assertEqualsRendered("LatinText", Std.string(c(x, p, p + 1)));
            xi++;
        }
    }
    ...
    @:test public static function classifiesAsciiSymbolsAndPunctuationAsLatin():Void {
        ...
        while (xi < xs.length) {
            var x = xs[xi];
            TracedAssertions.assertEqualsRendered("LatinText", Std.string(c(x, 0, 1)), "char=" + x);
            xi++;
        }
        TracedAssertions.assertEqualsRendered("LatinText", Std.string(c("中%文", 1, 2)));
    }
    ...
    @:test public static function classifiesCjkPunctuation():Void {
        ...
        while (i < a.length) {
            var x = a[i];
            TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c(x, 0, 1)));
            i++;
        }
    }
    ...
    @:test public static function classifiesCjkText():Void {
        ...
        TracedAssertions.assertEqualsRendered("CjkText", Std.string(c("提", 0, 1)));
    }
    ...
    @:test public static function classifiesCurlyQuotesAsCjkAtTextBoundary():Void {
        ...
        TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c("“你好”", 0, 1)));
        TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c("“你好”", 3, 4)));
    }
    ...
    @:test public static function classifiesCurlyQuotesAsCjkInMixedContext():Void {
        ...
        TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c("他说“hello”", 2, 3)));
        TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c("他说“hello”", 8, 9)));
    }
    ...
    @:test public static function classifiesCurlyQuotesAsCjkWhenSurroundedByCjk():Void {
        ...
        TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c("他说“你好”", 2, 3)));
        TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c("他说“你好”", 5, 6)));
        TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c("他说‘你好’", 2, 3)));
        TracedAssertions.assertEqualsRendered("CjkPunctuation", Std.string(c("他说‘你好’", 5, 6)));
    }
    ...
    @:test public static function classifiesCurlyQuotesAsLatinWhenSurroundedByLatin():Void {
        ...
        TracedAssertions.assertEqualsRendered("LatinText", Std.string(c("said “hello” end", 5, 6)));
        TracedAssertions.assertEqualsRendered("LatinText", Std.string(c("said “hello” end", 11, 12)));
        TracedAssertions.assertEqualsRendered("LatinText", Std.string(c("it’s", 2, 3)));
    }
    ...
    @:test public static function classifiesLatinText():Void {
        ...
        TracedAssertions.assertEqualsRendered("LatinText", Std.string(c("English", 0, 1)));
    }
    ...
    @:test public static function classifiesUnicodeEmojiPresentationWithoutReclassifyingPlainKeycapBases():Void {
        ...
        while (xi < xs.length) {
            var x = xs[xi];
            TracedAssertions.assertEqualsRendered("Emoji", Std.string(c(x, 0, x.length)), x);
            xi++;
        }
        TracedAssertions.assertEqualsRendered("LatinText", Std.string(c("1", 0, 1)));
        TracedAssertions.assertEqualsRendered("Symbol", Std.string(c("❤", 0, 1)));
    }
}
