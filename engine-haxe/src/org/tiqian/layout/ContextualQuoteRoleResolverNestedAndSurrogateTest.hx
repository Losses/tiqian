...
class ContextualQuoteRoleResolverNestedAndSurrogateTest {
    ...
    @:test(except = ["swift", "rust"]) public static function leftwardScanFromALowSurrogateWalksEveryBacktrackArm():Void {
    ...
    @:test(except = ["swift", "rust"]) public static function highSurrogateAtTheContentEndHasNoRoomAndThrows():Void {
    ...
    @:test(except = ["swift", "rust"]) public static function plainFollowerOfAHighSurrogateCountsAsOneUnit():Void {
    ...
    @:test(except = ["swift", "rust"]) public static function privateUseFollowerOfAHighSurrogateCountsAsOneUnit():Void {
