...
class UnicodeEmoji17RgiRoleAuditTest {
    @:test public static function fullyQualifiedEmojiSequencesResolveToOneEmojiRange():Void {
        ...
        final classifier = new CjkFontRoleClassifier(); var failures:Array<String> = [];
        ...
        TracedAssertions.assertEqualsInt(0, failures.length,
            failures.length + " RGI role mismatches: " + failures.slice(0, 20));
    }
}
