...
class LineBreakRepairEngineTestSupport {
    ...
    public static function layoutWithGrid(text:String, width:Float, gridEnabled:Bool, ?breaker:LineBreaker, ?hyphenator:Hyphenator, ?spans:Array<LineBreakSpan>):LayoutResult {
        return new ExplainableStubParagraphLayoutEngine(null,null,null,null,null,null,null,null,breaker,null,null,hyphenator,null).layout(
            new LayoutInput(new TiqianTextContent(text, spans == null ? [] : spans), null,
    ...
    public static function lineText(r:LayoutResult, n:Int):String {
        final l=r.lines[n]; var s=""; for(i in l.clusterRange.start...l.clusterRange.end + 1) s+=r.clusters[i].text; return s;
    }
    ...
    public static function fixed(?level:KinsokuLevel, ?hanging:HangingPunctuationStyle):ExplainableStubParagraphLayoutEngine {
        return new ExplainableStubParagraphLayoutEngine(null,null,new FixedProfileResolver(level, hanging),null,null,null,null,null,null,null,null,new NoHyphenator(),null);
    }
...
class FixedProfileResolver implements ClreqProfileResolver {
    ...
    public function resolve(id:LayoutProfileId):ClreqProfile {
        ...
        return new ClreqProfile(b.id,b.strictness,b.region,b.punctuationGlyphPolicy,null,b.autoSpace,b.gluePlacement,b.adjustment,KinsokuMode.Fixed(level, hanging),b.punctuationWidth);
    }
}
