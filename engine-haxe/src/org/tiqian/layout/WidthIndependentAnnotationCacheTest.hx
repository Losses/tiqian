...
class WidthIndependentAnnotationCacheTest {
    @:test public static function relayoutWithDifferentWidthHitsCacheAndSkipsShaper():Void {
        ...
        final inputWidth1 = new LayoutInput(
            new TiqianTextContent("\u63D0\u6920\u662F\u4E00\u4E2A\u9762\u5411\u4E2D\u6587\u6B63\u6587\u7684 CJK \u6BB5\u843D\u5E03\u5C40\u5F15\u64CE\u3002"),
            null,
    ...
    @:test public static function cachedAndUncachedEnginesProduceIdenticalLayoutResultsAcrossWidths():Void {
        ...
        final fixtures:Array<String> = ["\u63D0\u6920\u662F\u4E00\u4E2A\u9762\u5411\u4E2D\u6587\u6B63\u6587\u7684\u6BB5\u843D\u6392\u7248\u5F15\u64CE\uFF0C\u9075\u5FAA\u4E2D\u6587\u6392\u7248\u9700\u6C42\u89C4\u8303\uFF0C\u652F\u6301\u4E24\u7AEF\u5BF9\u9F50\u4E0E\u6807\u70B9\u6324\u538B\u3002", "\u5728\u300A\u4E2D\u6587\u6392\u7248\u9700\u6C42\u300B\uFF08CLREQ\uFF09\u4E2D\uFF0C\u8981\u6C42\u6B63\u6587\u300C\u4E24\u7AEF\u5BF9\u9F50\u300D\uFF1B\u5F53\u9047\u5230\u300E\u6807\u70B9\u7B26\u53F7\u300F\u4E0E\u897F\u6587\uFF08\u5982 OpenType / CSS Grid\uFF09\u6DF7\u6392\u65F6\uFF0C\u5E94\u6B63\u786E\u6267\u884C\u6324\u538B\u4E0E\u63A8\u5165\u63A8\u51FA\u2014\u2014\u5373\u4F7F\u5728 120Hz \u9AD8\u9891\u62D6\u62FD\u4E0B\u4E5F\u662F\u5982\u6B64\uFF01", "\u7B2C\u4E00\u884C\u7F29\u8FDB\u4E24\u4E2A\u5B57\u8EAB\u6846\u3002\u6807\u70B9\u7B26\u53F7\u5982\u2026\u2026\u7701\u7565\u53F7\u3001\u7834\u6298\u53F7\u2014\u2014\u4E0D\u5E94\u51FA\u73B0\u5728\u884C\u9996\uFF0C\u9017\u53F7\u3001\u53E5\u53F7\u3002\u4E5F\u4E0D\u5F97\u51FA\u73B0\u5728\u884C\u9996\u3002\u8FD9\u5C31\u662F\u907F\u5934\u5C3E\uFF08Kinsoku\uFF09\u89C4\u5219\u7684\u4E25\u683C\u8981\u6C42\u3002"];
        ...
        for (fixture in fixtures) {
            for (width in sweepWidths) {
                final input = new LayoutInput(
                    new TiqianTextContent(fixture),
                    null,
                    new ParagraphStyle(null, null, null, new Ic(2)),
    ...
    @:test public static function reflowFuzzingRandomSequenceProducesExactOutput():Void {
        ...
        final randomSequenceWidths = [320.0, 150.0, 480.5, 95.2, 210.0, 600.0, 120.3, 450.0, 180.7, 300.0, 75.0, 520.0, 133.3, 266.6, 399.9, 110.0, 470.0, 195.0, 345.0, 580.0];
    ...
    @:test public static function cacheKeyDistinguishesTypographyDecorationsAndSpans():Void {
        ...
        final baseInput = new LayoutInput(
            new TiqianTextContent("\u4E2D\u897F\u6DF7\u5408\u6392\u7248\u4E0E\u6D4B\u8BD5\u6587\u672C\u3002"),
            null,
            new ParagraphStyle(null, null, null, Ic.Zero),
            new LayoutConstraints(300)
        );
    ...
    @:test public static function lruCacheEvictsOldestEntriesWhenCapacityExceeded():Void {
        ...
        final input1 = new LayoutInput(new TiqianTextContent("\u6BB5\u843D\u4E00\u6587\u672C\u5185\u5BB9"), null, new ParagraphStyle(null, null, null, Ic.Zero), new LayoutConstraints(300));
        final input2 = new LayoutInput(new TiqianTextContent("\u6BB5\u843D\u4E8C\u6587\u672C\u5185\u5BB9"), null, new ParagraphStyle(null, null, null, Ic.Zero), new LayoutConstraints(300));
        final input3 = new LayoutInput(new TiqianTextContent("\u6BB5\u843D\u4E09\u6587\u672C\u5185\u5BB9"), null, new ParagraphStyle(null, null, null, Ic.Zero), new LayoutConstraints(300));
...
class NoOpWidthIndependentAnnotationCache implements WidthIndependentAnnotationCache {
    ...
    public function get(key:WidthIndependentAnnotationKey):Null<WidthIndependentParagraphAnnotation> return null;
