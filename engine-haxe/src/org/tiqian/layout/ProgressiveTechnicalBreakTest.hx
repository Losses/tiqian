...
class ProgressiveTechnicalBreakTest {
    @:test public static function sourceWhitespaceCapacityKeepsStructuralTierAheadOfSyllable():Void {
        ...
        final c = [ProgressiveTechnicalBreakTestSupport.cluster(0,"a",20),ProgressiveTechnicalBreakTestSupport.cluster(1," ",4),ProgressiveTechnicalBreakTestSupport.cluster(2,"b",28),ProgressiveTechnicalBreakTestSupport.cluster(3,"/",28),ProgressiveTechnicalBreakTestSupport.cluster(4,"c",2),ProgressiveTechnicalBreakTestSupport.cluster(5,"d",20)];
        final o = ProgressiveTechnicalBreakTestSupport.opportunityMap([2,4,5], [new ProgressiveBreakOpportunity(ProgressiveBreakTier.Whitespace,span,4),new ProgressiveBreakOpportunity(ProgressiveBreakTier.Structural,span),new ProgressiveBreakOpportunity(ProgressiveBreakTier.Syllable,span)]);
    ...
    @:test public static function lookaheadMayNotReplaceSelectedEmergencyBoundaryWithEarlierSameTierCut():Void {
        ...
        final span = new TextRange(0,5); final c = [for (i in 0...5) ProgressiveTechnicalBreakTestSupport.cluster(i,String.fromCharCode(97+i),20)];
        final o = ProgressiveTechnicalBreakTestSupport.opportunityMap([3,4],[new ProgressiveBreakOpportunity(ProgressiveBreakTier.Emergency,span),new ProgressiveBreakOpportunity(ProgressiveBreakTier.Emergency,span)]);
