...
class AutoSpaceSingleGapTestSupport {
    ...
    public static function letterDigit():LayoutResult {
        final engine = new ExplainableStubParagraphLayoutEngine(null, null, new AutoSpaceLetterDigitResolver(),
            null, null, null, null, null, null, null, null, null, null);
        return engine.layout(new LayoutInput(new TiqianTextContent("甲A乙9丙"), null,
...
class AutoSpaceLetterDigitResolver implements ClreqProfileResolver {
    ...
    public function resolve(profileId:org.tiqian.core.LayoutProfileId):ClreqProfile {
        ...
        return new ClreqProfile(base.id, base.strictness, base.region, base.punctuationGlyphPolicy,
            null, new AutoSpacePolicy(AutoSpaceMode.Insert, AutoSpaceMode.Disabled),
            base.gluePlacement, base.adjustment, base.kinsokuMode, base.punctuationWidth);
    }
}
