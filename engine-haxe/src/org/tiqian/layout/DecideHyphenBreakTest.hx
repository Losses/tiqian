...
class DecideHyphenBreakTest {
 ...
 static var cs=[c(0,16),c(1,16),c(2,32),c(3,32),c(4,32)]; static function m(a:Array<Int>):SortedSet<Int>{final b=SortedSet.builder();var j=0;while(j<a.length){b.put(a[j]);j++;}return b.build();}
