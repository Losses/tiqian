...
class LineAdjustmentPushInTestSupport {
    ...
    public static function forbiddenHeadStartClusters():Array<Cluster> return [
    ...
    public static function forbiddenHeadEndClusters():Array<Cluster> return [
        LineAdjustmentPushInTestSupport.cluster(0, "甲", 30),
        LineAdjustmentPushInTestSupport.cluster(1, "乙", 30),
    ...
    public static function technicalClusters():Array<Cluster> return [
    ...
    public static function fill(
        cs:Array<Cluster>,
        width:Float,
        ?shrink:Array<ShrinkOpportunity>,
        ?starts:Array<Int>,
        ?ends:Array<Int>,
        ?progressive:SortedMap<Int, ProgressiveBreakOpportunity>,
        ?splitAt:Int
    ):Array<LineCandidate> {
        ...
        var gapsArr = [];
        for (i in 0...(cs.length - 1)) gapsArr.push(i);
        return LineRepair.applyFillPushIn(
            a,
            cs,
            cs,
            width,
            ...
            0,
            1000000,
            starts == null ? null : LineAdjustmentPushInTestSupport.ints(starts),
            LineAdjustmentPushInTestSupport.ints(ends == null ? [] : ends),
            LineAdjustmentPushInTestSupport.emptyRanges(),
            2,
            LineAdjustmentPushInTestSupport.ints(gapsArr),
            progressive
        );
    }
    ...
    public static function layout(strategy:LineAdjustmentStrategy):LayoutResult {
        ...
        final engine = new ExplainableStubParagraphLayoutEngine(
            null, null, resolver, null, null, null, null, null, new LookaheadLineBreaker()
        );
