...
class AsciiPointMarkKinsokuTestSupport {
    ...
    public static function nullFallback(r:LayoutResult):String { final d=contextual(r,null); return d==null||d.impossibleMeasureFallback==null?"":d.impossibleMeasureFallback; }

    public static function layout(text:String, maxWidth:Float, breaker:LineBreaker, ?level:Null<KinsokuLevel>,
            ?hanging:Null<HangingPunctuationStyle>, ?firstLineIndent:Null<Ic>, ?rubySpans:Array<RubySpan>,
            ?spans:Array<TextSpan>, ?lineLengthGrid:Null<LineLengthGrid>):LayoutResult {
        ...
        final engine = new ExplainableStubParagraphLayoutEngine(null, null,
            new AsciiKinsokuFixedResolver(resolvedLevel, resolvedHanging),
        ...
        return engine.layout(new LayoutInput(new TiqianTextContent(text, spans), null,
            new ParagraphStyle(null, null, null, resolvedIndent, null, null, resolvedGrid),
...
class AsciiKinsokuFixedResolver implements ClreqProfileResolver {
    ...
    public function resolve(profileId:org.tiqian.core.LayoutProfileId):ClreqProfile {
        ...
        return new ClreqProfile(base.id, base.strictness, base.region, base.punctuationGlyphPolicy,
            null, null, base.gluePlacement, base.adjustment, KinsokuMode.Fixed(level, hanging), base.punctuationWidth);
    }
}
