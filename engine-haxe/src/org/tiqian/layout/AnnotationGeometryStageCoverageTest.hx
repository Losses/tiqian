...
class AnnotationGeometryStageCoverageTest {
    @:test public static function inlineObjectDecisionsWithPreferredStretchAndFixed():Void {
        ...
        final objWithStretch = new InlineObjectSpan(new TextRange(4, 5), 30.0, 12.0, 4.0,
            new InlineObjectBoundaryAdjustment(true, new InlineObjectPreferredStretch(InlineObjectPreferredStretchKind.PunctuationTrailing, 10.0, 15.0), null, null, true),
        ...
        final objFixed = new InlineObjectSpan(new TextRange(6, 7), 20.0, 10.0, 2.0,
            InlineObjectBoundaryAdjustment.fixed(), InlineObjectBoundaryAdjustment.fixed());
        final input = new LayoutInput(new TiqianTextContent(text), null, null, new LayoutConstraints(300.0), null, null, null, null, [objWithStretch, objFixed]);
    ...
    @:test public static function decorationDecisionsEmphasisOnHanPunctuationAndWestern():Void {
        ...
        final input = new LayoutInput(new TiqianTextContent("\u6C49\u5B57\uFF0C\u3002English"), null, new ParagraphStyle(null, null, null, null, null, null, null, null, null, 0.2), new LayoutConstraints(300.0), null, [new DecorationSpan(new TextRange(0, 11), DecorationKind.Emphasis)]);
        final result = engine.layout(input);
        TracedAssertions.assertNotNullRendered(result != null, result == null ? "null" : TestTraceRender.cap(Std.string(result)));
    }
    ...
    @:test public static function decorationSegmentsMourningProperNounBookTitleAndShortening():Void {
        ...
        final input = new LayoutInput(new TiqianTextContent("\u5F20\u4E09\u674E\u56DB\u738B\u4E94\u8D75\u516D\u94B1\u4E03\u5B59\u516B\u5468\u5434\u90D1\u738B"), null, null, new LayoutConstraints(120.0), null, [new DecorationSpan(new TextRange(0, 2), DecorationKind.ProperNoun), new DecorationSpan(new TextRange(2, 4), DecorationKind.ProperNoun), new DecorationSpan(new TextRange(4, 8), DecorationKind.BookTitle), new DecorationSpan(new TextRange(8, 12), DecorationKind.Mourning), new DecorationSpan(new TextRange(0, 16), DecorationKind.Mourning)]);
        final result = engine.layout(input);
        TracedAssertions.assertNotNullRendered(result != null, result == null ? "null" : TestTraceRender.cap(Std.string(result)));
    }
    ...
    @:test public static function rubyDecisionsPinyinSingleAndSplitLines():Void {
        ...
        final input = new LayoutInput(new TiqianTextContent(text), null, null, new LayoutConstraints(100.0), null, null,
            [new RubySpan(new TextRange(0, 2), "zh\u00E8sh\u00EC", null, RubyKind.Pinyin, "zh-Latn"), new RubySpan(new TextRange(2, 6), "y\u012Bgeh\u011Bnch\u00E1ng", null, RubyKind.Pinyin, null), new RubySpan(new TextRange(6, 12), "ch\u00E1ngdedu\u00E0nlu\u00F2", null, RubyKind.Pinyin, null)]);
        final result = engine.layout(input);
        TracedAssertions.assertNotNullRendered(result != null, result == null ? "null" : TestTraceRender.cap(Std.string(result)));
    }
    ...
    @:test public static function bopomofoDecisionsAllTonesAndSymbolCounts():Void {
        ...
        final rubySpans = [new RubySpan(new TextRange(0, 1), "\u02D9\u3105", null, RubyKind.Bopomofo, "zh-Bopo"), new RubySpan(new TextRange(1, 2), "\u02D9\u3105\u3106", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(2, 3), "\u02D9\u3105\u3106\u3107", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(3, 4), "\u3105\u02CA", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(4, 5), "\u3105\u3106\u02CA", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(5, 6), "\u3105\u3106\u3107\u02CA", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(6, 7), "\u3105\u02C7", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(7, 8), "\u3105\u3106\u02C7", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(8, 9), "\u3105\u3106\u3107\u02C7", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(9, 10), "\u3105\u02CB", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(10, 11), "\u3105\u3106\u02CB", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(11, 12), "\u3105\u3106\u3107\u02CB", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(12, 13), "\u3105", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(13, 14), "\u3105\u3106", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(14, 15), "\u3105\u3106\u3107", null, RubyKind.Bopomofo, null)];
    ...
    @:test public static function directResolveAnnotationGeometryFallbackBranches():Void {
        ...
        final clusters = [new Cluster(new TextRange(0, 2), "\u6C49\u5B57", "k", 32.0, "\u6C49\u5B57"),
        ...
        final lineBoxes = [new LineBox(new TextRange(0, 5), new IntRange(0, 2), 16.0, 0.0, 20.0, 80.0, 80.0, 80.0,
            null, 0.0, LineEndReason.AutoWrap, null, null, new LineDebugInfo(null)),
            new LineBox(new TextRange(5, 12), new IntRange(3, 3), 36.0, 20.0, 40.0, 56.0, 56.0, 56.0,
            null, 0.0, LineEndReason.MandatoryBreak, null, null, new LineDebugInfo(null))];
        final lineSolution = new LineSolution([new LineCandidate(new IntRange(0, 2), new TextRange(0, 5), 80.0, 80.0, LineEndReason.AutoWrap),
        ...
        final geomDecision = new ClusterGeometryDecisionInfo(new TextRange(0, 2), "\u6C49\u5B57", "\u6C49\u5B57", 32.0, 32.0, 4.0, 2.0, 4.0, 2.0, 0.0, 32.0, "test", "test");
        ...
        final res1 = LineAdjustmentStage.resolveAnnotationGeometry(engine, input, 16.0, inlineObjMap, lineSolution, clreqProfile, [geomDecision],
            [new AutoSpaceDecisionInfo(new TextRange(0, 2), "leading", "Wide", "Normal", 1, 0.0, 0.0, "test"), new AutoSpaceDecisionInfo(new TextRange(2, 3), "leading", "Wide", "Normal", 1, 0.0, 0.0, "test"), new AutoSpaceDecisionInfo(new TextRange(3, 5), "trailing", "Wide", "Normal", 1, 0.0, 0.0, "test"), new AutoSpaceDecisionInfo(new TextRange(5, 12), "trailing", "Wide", "Normal", 1, 0.0, 0.0, "test")],
            [new IntRange(0, 2), new IntRange(3, 3)], lineBoxes, clusters,
            [FontRole.CjkText, FontRole.CjkPunctuation, FontRole.CjkText, FontRole.LatinText], justifyMap, spreadMap, [], [pinyinA, pinyinB], clusters,
            rfgMap, 0.0, 16.0, 8.0, 400, 4.0, function(_:Int) return 400);
        ...
        final metricDecision = new ClusterMetricDecision(new TextRange(0, 2), "\u6C49\u5B57",
            new FontMetricsRequest("k", 16.0, FontRole.CjkText, "zh-Hans"), new RawFontMetrics(14.0, 4.0),
            new LayoutFontMetrics(14.0, 4.0, 0.0, FontMetricsPolicy.Raw, BaselinePolicy.Alphabetic));
        ...
        final res2 = LineAdjustmentStage.resolveAnnotationGeometry(engine, input, 16.0, SortedMap.builder().build(), lineSolution, clreqProfile, [], [],
            [new IntRange(0, 2), new IntRange(3, 3)], lineBoxes, clusters,
            [FontRole.CjkText, FontRole.CjkPunctuation, FontRole.CjkText, FontRole.LatinText], SortedMap.builder().build(), SortedMap.builder().build(),
            [metricDecision], [pinyinC], clusters, rfgMap2, 0.0, 16.0, 8.0, 400, 4.0, function(_:Int) return 400);
    ...
    @:test public static function bopomofoDecisionsMultiGlyphMinMaxAndEmptyPlacements():Void {
        ...
        final text = "\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B";
        final rubySpans = [new RubySpan(new TextRange(0, 2), "\u3105\u3106\u02CA", null, RubyKind.Bopomofo, "zh-Bopo"), new RubySpan(new TextRange(2, 3), " ", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(3, 4), "\u3105", null, RubyKind.Bopomofo, null),
            new RubySpan(new TextRange(4, 5), "\u02D9\u3105", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(5, 6), "\u3105\u02C7", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(6, 7), "\u3105\u02CB", null, RubyKind.Bopomofo, null)];
        final input = new LayoutInput(new TiqianTextContent(text), null, null, new LayoutConstraints(300.0), null, null, rubySpans);
        final result = engine.layout(input);
        TracedAssertions.assertNotNullRendered(result != null, result == null ? "null" : TestTraceRender.cap(Std.string(result)));
    }
    ...
    @:test public static function directResolveAnnotationGeometryEmptyLineRangesAndGapAtLineEdges():Void {
        ...
        final text = "\u6C49\u5B57\uFF0C\u6D4B\u8BD5English";
        final input = new LayoutInput(new TiqianTextContent(text), null, null, new LayoutConstraints(300.0), null,
            [new DecorationSpan(new TextRange(0, 2), DecorationKind.Emphasis), new DecorationSpan(new TextRange(0, 5), DecorationKind.ProperNoun)]);
        final clusters = [new Cluster(new TextRange(0, 2), "\u6C49\u5B57", "k", 32.0, "\u6C49\u5B57"),
            new Cluster(new TextRange(2, 3), "\uFF0C", "k", 16.0, "\uFF0C"),
            new Cluster(new TextRange(3, 5), "\u6D4B\u8BD5", "k", 32.0, "\u6D4B\u8BD5"),
            new Cluster(new TextRange(5, 12), "English", "k", 56.0, "English")];
        final lineBoxes = [new LineBox(new TextRange(0, 0), new IntRange(1, 0), 0.0, 0.0, 20.0, 0.0, 0.0, 0.0,
                null, 0.0, LineEndReason.AutoWrap, null, null, new LineDebugInfo(null)),
            new LineBox(new TextRange(0, 5), new IntRange(0, 2), 16.0, 0.0, 20.0, 80.0, 80.0, 80.0,
            null, 0.0, LineEndReason.AutoWrap, null, null, new LineDebugInfo(null))];
        final lineSolution = new LineSolution([new LineCandidate(new IntRange(1, 0), new TextRange(0, 0), 0.0, 0.0, LineEndReason.AutoWrap),
            new LineCandidate(new IntRange(0, 2), new TextRange(0, 5), 80.0, 80.0, LineEndReason.AutoWrap)]);
        final clreqProfile = engine.clreqProfileResolver.resolve(input.profileId);
        final geomDecision = new ClusterGeometryDecisionInfo(new TextRange(0, 2), "\u6C49\u5B57", "\u6C49\u5B57", 32.0, 32.0, 4.0, 2.0, 4.0, 2.0, 0.0, 32.0, "test", "test");
        final metricDecision1 = new ClusterMetricDecision(new TextRange(0, 2), "\u6C49\u5B57",
            new FontMetricsRequest("k", 24.0, FontRole.CjkText, "zh-Hans"), new RawFontMetrics(18.0, 6.0),
        ...
        final inlineObject2 = new InlineObjectSpan(new TextRange(15, 17), 32.0, 16.0, 4.0,
            new InlineObjectBoundaryAdjustment(null, null),
        ...
        final res = LineAdjustmentStage.resolveAnnotationGeometry(engine, input, 16.0, inlineObjMap, lineSolution, clreqProfile, [geomDecision],
            [new AutoSpaceDecisionInfo(new TextRange(0, 2), "leading", "Wide", "Normal", 1, 0.0, 0.0, "test"), new AutoSpaceDecisionInfo(new TextRange(2, 3), "leading", "Wide", "Normal", 1, 0.0, 0.0, "test"), new AutoSpaceDecisionInfo(new TextRange(2, 3), "trailing", "Wide", "Normal", 1, 0.0, 0.0, "test"), new AutoSpaceDecisionInfo(new TextRange(3, 5), "trailing", "Wide", "Normal", 1, 0.0, 0.0, "test")],
            [new IntRange(1, 0), new IntRange(0, 2)], lineBoxes, clusters,
            [FontRole.CjkText, FontRole.CjkPunctuation, FontRole.CjkText, FontRole.LatinText], SortedMap.builder().build(), SortedMap.builder().build(),
            [metricDecision1, metricDecision2], [pinyinA, pinyinB, pinyinC], clusters, rfgMap, 0.0, 16.0, 8.0, 400, 4.0, function(_:Int) return 400);
    ...
    @:test public static function bopomofoAndDecorationLeadingBlankExhaustiveBranches():Void {
        ...
        final input = new LayoutInput(new TiqianTextContent(text), null, null, new LayoutConstraints(500.0), null,
            [new DecorationSpan(new TextRange(0, 7), DecorationKind.ProperNoun), new DecorationSpan(new TextRange(2, 7), DecorationKind.ProperNoun)],
            [new RubySpan(new TextRange(0, 1), "\u3105", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(1, 2), "\u3106", null, RubyKind.Bopomofo, "zh-TW"), new RubySpan(new TextRange(0, 1), "", null, RubyKind.Bopomofo, null)]);
    ...
    @:test public static function bopomofoOverLatinClustersCoversCrossMetricLookup():Void {
        ...
        final input = new LayoutInput(new TiqianTextContent(text), null, null, new LayoutConstraints(500.0), null, null,
            [new RubySpan(new TextRange(2, 3), "\u3105", null, RubyKind.Bopomofo, null), new RubySpan(new TextRange(3, 4), "\u3106", null, RubyKind.Bopomofo, "zh-TW")]);
        final res = engine.layout(input);
        TracedAssertions.assertNotNullRendered(res != null, res == null ? "null" : TestTraceRender.cap(Std.string(res)));
    }
