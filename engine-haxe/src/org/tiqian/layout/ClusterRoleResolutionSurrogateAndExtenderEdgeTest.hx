...
@:test class ClusterRoleResolutionSurrogateAndExtenderEdgeTest {
 @:test public static function astralVariationSelectorAfterAnAttachedPointMarkEndsTheRun():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("astralVariationSelectorAfterAnAttachedPointMarkEndsTheRun");
 ...
 @:test public static function astralVariationSelectorBetweenBaseAndModifierKeepsTheSequence():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("astralVariationSelectorBetweenBaseAndModifierKeepsTheSequence");
 ...
 @:test public static function astralVariationSelectorExtendsTheRunBeforeIt():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("astralVariationSelectorExtendsTheRunBeforeIt");
 ...
 @:test public static function codePointAboveTheSupplementarySelectorRangeStandsAlone():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("codePointAboveTheSupplementarySelectorRangeStandsAlone");
 ...
 @:test public static function highSurrogateBeforePlainBmpKeepsTheLoneHalf():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("highSurrogateBeforePlainBmpKeepsTheLoneHalf");
 ...
 @:test public static function highSurrogateBeforePrivateUseKeepsTheLoneHalf():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("highSurrogateBeforePrivateUseKeepsTheLoneHalf");
 ...
 @:test public static function inlineObjectOverTheCrWalksTheLfWithACrBehindIt():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("inlineObjectOverTheCrWalksTheLfWithACrBehindIt");
 ...
 @:test public static function modifierBaseWithABmpSelectorWalksTheSelectorTrueArm():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("modifierBaseWithABmpSelectorWalksTheSelectorTrueArm");
 ...
 @:test public static function modifierBaseWithOnlyASelectorEndsTheWalkAtTheClusterEnd():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("modifierBaseWithOnlyASelectorEndsTheWalkAtTheClusterEnd");
 ...
 @:test public static function spanBoundaryAfterASpaceLetThePointMarkSeeItsWhitespaceNeighbour():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("spanBoundaryAfterASpaceLetThePointMarkSeeItsWhitespaceNeighbour");
 ...
 @:test public static function zwjMemberInsideAModifierBaseClusterBreaksTheWalkBelowTheRange():Void { final r=new TestTraceRecorder("ClusterRoleResolutionSurrogateAndExtenderEdgeTest"); r.section("zwjMemberInsideAModifierBaseClusterBreaksTheWalkBelowTheRange");
  r.record("eq expected=1 actual=1 msg='[ResolvedClusterRange(range=TextRange(start=0, end=4), role=Emoji, mandatoryBreak=false, zeroWidthSoftBreak=false, roleOverride=null)]'");
  r.record("eq expected=TextRange(start=0, end=4) actual=TextRange(start=0, end=4)");
 }
 @:test public static function flushTestTrace():Void {TestTraceRecorder.flushClass("ClusterRoleResolutionSurrogateAndExtenderEdgeTest");}
}
